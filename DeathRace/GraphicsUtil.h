...
void DrawText(Font font, const char* text, Vector2 pos, float fontSize, float spacing);
void DrawText(Font font, std::string text, Vector2 pos, float fontSize, float spacing);
